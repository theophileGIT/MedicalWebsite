      ...
      <div className="bg-brandWhite rounded-3xl container grid grid-cols-1 md:grid-cols-2 gap-6 min-h-[650px]">
        <div className="flex flex-col justify-center xl:pr-40">
          <div className="mt-24 mb-10 md:mt-0 md:mb-0 space-y-6 text-center md:text-left">
            ...
            >
              Bienvenue au Cabinet Médical <br /> BERTHE CANION
            </motion.h1>
            <motion.p
            ...
            >
              Votre cabinet médical vous acceuil tous les jours de la semaine <br />
            ...
            >
              <a href="https://www.msp-louvsante.fr/" target="_blank">
                <button>Prende rendez-vous? Cliquez-ici</button>
              </a>
            </motion.div>
          </div>
        </div>
...
>
  <img src={HeroImage} alt="" style={{ width: "1000px", height: "auto" }} /> 
</motion.div>
